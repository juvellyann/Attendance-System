...
public class TeacherCreateDelete extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_create_delete);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.Add:
                ...
                startActivity(new Intent(this, TeacherWall.class));
                break;
            case R.id.Remove:
